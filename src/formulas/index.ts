import {EQUAL_PAYMENTS_STRATEGY, generateEqualPayments} from "./EqualPayments";
import {generateSomeOtherPayments, SOME_OTHER_PAYMENTS_STRATEGY} from "./SomeOtherPayments";
